//! `clawai init` — create the ClawAI configuration directory with defaults.
...
const DEFAULT_CONFIG: &str = r#"# ClawAI Configuration
# See https://github.com/clawai/clawai for documentation.

# Path to the policy rules file.
# policy_path = "~/.config/clawai/policy.toml"

# Path to the audit log.
# audit_log_path = "~/.local/share/clawai/audit.jsonl"
...
fn config_dir() -> Result<PathBuf> {
    ...
    Ok(PathBuf::from(home).join(".config/clawai"))
}
