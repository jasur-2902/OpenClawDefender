//! Event types for ClawAI.
//!
//! Events are the fundamental data unit flowing through ClawAI. They originate
...
/// Common trait implemented by every event flowing through ClawAI.
