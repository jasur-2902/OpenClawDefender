//! Professional security report generation system for ClawDefender.
//!
...
<title>ClawDefender — {title}</title>
<style>
  body {{
...
<header style="text-align:center; margin-bottom:2rem;">
  <h1 style="border-bottom:none; margin-bottom:0;">ClawDefender</h1>
...
fn render_daily_brief(data: &DailyBriefData) -> String {
    ...
    md.push('\n');
    md.push_str("---\n\n");
    md.push_str("*Generated by ClawDefender Report System*\n");
...
fn default_reports_dir() -> PathBuf {
    ...
    PathBuf::from(home).join(".local/share/clawdefender/reports")
}
...
mod tests {
    ...
    fn test_to_html_structure() {
        ...
        assert!(html.contains("</html>"));
        assert!(html.contains("ClawDefender"));
    ...
    fn test_export_report_to_html() {
        ...
        assert!(html_content.contains("ClawDefender"));
    }
