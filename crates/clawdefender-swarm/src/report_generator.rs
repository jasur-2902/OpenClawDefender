...
impl ReportGenerator {
    ...
    pub fn generate(
        ...
        let report = ScanReport {
            ...
            format,
            title: "ClawDefender Security Scan Report".to_string(),
    ...
    pub fn render_markdown(&self, report: &ScanReport) -> String {
        ...
        md.push_str("---\n\n");
        md.push_str("*Generated by ClawDefender AI Scanner*\n");
...
mod tests {
    ...
    fn test_render_markdown_contains_sections() {
        ...
        assert!(md.contains("*Generated by ClawDefender AI Scanner*"));
    }
